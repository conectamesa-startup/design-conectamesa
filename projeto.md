| **Comportamento Digital** | Usuário extensivo de WhatsApp Business e Instagram para atendimento. Ferramentas complexas de retaguarda geram fadiga cognitiva. Necessita de interfaces utilitaristas de alto contraste e resposta em milissegundos via app nativo. |

### Persona 2 — A Consumidora Sensível a Preço (Pilar B2C)
...
| **Objetivos Primários** | Restaurar a dignidade alimentar e acessar insumos in natura, pães artesanais e laticínios de qualidade dentro de restrições drásticas de orçamento. Busca descontos acima de 50% para que a cesta básica dure até o encerramento do mês. |
| **Objeções à Plataforma** | Estigma antropológico da 'sobra'. Receio justificado de dispender esforço logístico (custo de deslocamento) para buscar mercadoria que apresente indícios de deterioração ou cujas fotos no app não condizem com a realidade da gôndola. |
| **Comportamento Digital** | Alta adoção de PIX e QR Codes. Heavy user de redes sociais, cashback e apps de delivery. Responde proativamente a notificações push geolocalizadas com gatilhos de urgência ('Restam apenas 3 unidades'). |

### Persona 3 — A Coordenadora de Ação Social (Pilar B2G/B2B2C)
...
| **Objetivos Primários** | Assegurar estabilidade no suprimento de biomassa nutricional para planejamento de cardápios semanais. Reduzir atritos de roteamento logístico e garantir que alimentos doados atendam padrões rigorosos de segurança microbiológica. |
| **Objeções à Plataforma** | Rechaça soluções que exijam dispêndio financeiro para retiradas fragmentadas (buscar 2kg num bairro distante é inviável — o custo do combustível supera o valor do ativo). Teme responsabilização sanitária por doações contaminadas na origem. |
| **Comportamento Digital** | Comunicação e planejamento quase integralmente via grupos de WhatsApp. Conectividade móvel mediana. Requer dashboard em tempo real evidenciando 'Hotspots' de doações massivas em hipermercados próximos para otimizar a frota de resgate. |
...
| **Infinineat (BR)** | Dashboard ESG preditivo potente. R$ 56,8M em economias atestadas para grandes redes. | Zero canal B2C. Atende apenas corporações com metas ESG robustas; ignora pequeno varejo. |
...
- **Modelo Híbrido Único:** Redistribuição comercial e doação assistencial dentro do mesmo fluxo unificado de software — solucionando simultaneamente a dor do comerciante (fluxo de caixa) e a exigência de responsabilidade social corporativa da Lei 15.224/2025.
- **Marketplace Transparente vs. Opacidade Competitiva:** Ficha técnica completa com macronutrientes, alérgenos e data de validade atestada por IA — eliminando a principal objeção emocional do consumidor e o principal gargalo operacional das ONGs.
- **Integração ESG Self-Service:** Qualquer pequeno empório de bairro acessa os mesmos relatórios de impacto ambiental que um hipermercado — sem necessidade de consultoria presencial, democratizando a governança ESG.
- **Network Effect Hiperlocal:** A estratégia de crescimento por densidade geográfica em bairros selecionados da RMR cria barreiras de entrada relacionais densas antes que players globais decidam alocar capital no Nordeste brasileiro.
...
O Conecta Mesa opera um modelo de monetização híbrido e progressivo, concebido para eliminar o atrito de entrada do pequeno varejo enquanto constrói escalabilidade de receita:

**Pilar Principal — Take Rate Transacional B2C**

Comissão por venda (take rate) calculada no espectro competitivo de 20% a 30% sobre o total pago pelo consumidor por cada reserva de produto no aplicativo. A plataforma não imputa taxas de mensalidade às pequenas padarias e hortifrutis na fase de adesão, dissolvendo o atrito primordial de entrada no B2B. O mecanismo de Split de Pagamentos da API Asaas aparta automaticamente o percentual da plataforma e direciona o restante à carteira digital do estabelecimento, eliminando reconciliação manual de caixa.

**Pilar Secundário — SaaS Analytics e Dashboard ESG B2B**

Pacotes corporativos de acesso a Dashboards de Impacto Premium para redes atacadistas e corporações pressionadas por metas ESG. O software gera automaticamente a matriz técnica de emissão de CO₂ equivalente mitigado — viabilizando relatórios para investidores em fundos sustentáveis, demonstrações operacionais e obtenção do Selo Doador de Alimentos e de isenções tributárias estaduais (ICMS) em Pernambuco.

**Pilar Social — Módulo B2G Subsidiado**

ONGs e cozinhas solidárias operam sem comissionamento na plataforma. Esta vertente é isenta não por incapacidade de monetização, mas por design estratégico: os resgates assistenciais na base B2G são as engrenagens silenciosas que impulsionam o volume da mitigação ambiental nos painéis ESG — que, por sua vez, alavancam a receita auferida na cobrança do acesso analítico dos atacadistas B2B.
...
- Utilização da Lei nº 15.224/2025 como argumento de venda: o Conecta Mesa converte o compliance legal em ativo de reputação (Selo Doador de Alimentos).
...
**Conteúdo Viral em Redes Sociais (TikTok / Reels)**

A temática de combate ao desperdício alimentar gera atenção orgânica massiva nas redes. A estratégia de conteúdo documenta narrativas reais e altamente compartilháveis: 'O que compramos com R$ 15,00 no app em Boa Viagem?', 'Como esses vegetais resgatados impediram montanhas de lixo tóxico nos aterros de Pernambuco?'. A humanização da cadeia — mostrar o comerciante, a consumidora e a cozinha solidária — amplifica o alcance orgânico sem despesas proporcionais com propaganda comercial tradicional.

**Narrativas Sociais: Fome vs. Desperdício**

O paradoxo entre insegurança alimentar e descarte massivo é intrinsecamente mobilizador. Campanhas que evidenciam dados concretos combinadas com histórias pessoais reais dos usuários criam vínculo emocional duradouro e impulsionam o crescimento viral orgânico.
...
- **Dashboard B2B de Impacto Mensal:** O estabelecimento enxerga sua volumetria de ativos recuperados (CMV salvo), emissões mitigadas e rastreabilidade digital completa — gerando orgulho e comprometimento com a plataforma.
...
|---|---|
| **Sustentabilidade** | Cada transação é uma emissão de CO₂ evitada. Os relatórios de impacto ambiental automatizados não são opcional — são funcionalidade core do produto. |
...
O fluxo de cadastro de produtos não permite inserção manual cega de datas de validade para itens industrializados. O comerciante é forçado pela UX a capturar, via câmera, o carimbo oficial de lote e validade na embalagem. O sistema utiliza a biblioteca **Google ML Kit (Vision API)** — embarcada diretamente no aplicativo Flutter — para processar a extração de texto no próprio dispositivo (Edge Computing), sem necessidade de envio ao servidor.

Se o algoritmo identificar uma data pretérita, o envio ao banco de dados é instantaneamente bloqueado, alertando o vendedor sobre a irregularidade sanitária. Esta camada é o principal mecanismo de prevenção de fraudes e passivos legais da plataforma.

> **Glossário:** OCR (Optical Character Recognition) é a tecnologia que transforma imagens de texto em texto digital legível por máquina. ML (Machine Learning) é a capacidade do sistema de aprender padrões a partir de dados para tomar decisões automatizadas. Edge Computing significa que o processamento ocorre no próprio dispositivo do usuário, não em servidores remotos — resultando em maior velocidade e privacidade.

### 11.2 Matchmaking de Oferta e Demanda

O algoritmo de matchmaking conecta, em tempo real, o excedente disponível ao perfil de demanda mais próximo — considerando geolocalização, histórico de consumo, restrições alimentares e urgência temporal do produto. Para ONGs, o sistema identifica automaticamente 'Hotspots' de doações massivas centralizadas em supermercados próximos, otimizando a rota de resgate.
...
Flutter é o framework de desenvolvimento multiplataforma do Google. Um único código-base gera aplicativos nativos para iOS e Android simultaneamente, sem perda de performance ou experiência de usuário. Para o Conecta Mesa, isso significa velocidade de entrega acelerada, consistência visual entre plataformas e redução de custo de engenharia — fatores críticos em uma startup early-stage.

### 12.2 Padrão Arquitetural — MVVM

O Conecta Mesa adota o padrão MVVM (Model-View-ViewModel) para organização do código frontend:

| Camada | Responsabilidade |
|---|---|
| **Model (Modelo)** | Dados e regras de negócio — ex: estrutura de uma transação, validação de produto. |
| **View (Interface)** | O que o usuário vê e toca — telas, botões, formulários, animações. |
| **ViewModel** | Intermediário que conecta dados às telas, sem que uma conheça os detalhes da outra. |
...
O código é organizado por funcionalidades de negócio (features), não por tipo de arquivo. Cada feature (ex: marketplace, pagamento, usuário, doação, gamificação) contém todos os seus arquivos de interface, lógica e dados em um único diretório independente. Isso facilita a localização de código, a divisão de trabalho entre times e a adição de novas funcionalidades sem impactar as existentes.

### 12.4 Backend — Supabase + PostgreSQL

**PostgreSQL Relacional**

Banco de dados principal do Conecta Mesa. Gerencia entidades estritamente relacionais: Lojas, Usuários, Produtos, Transações, Repasses e Entidades Assistenciais. As restrições de integridade do PostgreSQL asseguram que saldos não sejam corrompidos em alta concorrência. O Row Level Security (RLS) — regras configuradas nativamente no banco — impede que qualquer cliente force acesso aos dados transacionais de concorrentes.

**Supabase Realtime (Coração Logístico)**

Componente tecnológico fundamental para a experiência em tempo real. Utilizando PostgreSQL Changes acoplado a conexões WebSocket persistentes, os painéis de todos os usuários são atualizados instantaneamente sem necessidade de recarga de página. Exemplo: quando uma ONG confirma uma reserva de 20 kg de vegetais doados por um supermercado, todos os usuários visualizando o mesmo item veem o botão mudar para 'Esgotado' imediatamente — erradicando o problema de pedidos duplicados e overselling.

> **WebSocket** é uma tecnologia de comunicação bidirecional persistente entre o aplicativo e o servidor, que permite atualizações em tempo real sem que o usuário precise recarregar a tela. É o mesmo mecanismo usado em aplicativos de mensagens instantâneas.

**Supabase Storage**

Orquestração de armazenamento escalável com cacheamento de borda (CDN) para o intenso tráfego de imagens fotográficas enviadas diariamente pelos comerciantes como evidência dos produtos publicados.

**Edge Functions**

Micro-serviços serverless para gatilhos que requerem isolamento crítico: invocação segura da API de pagamentos Asaas para emissão de PIX dinâmico e processamento de cronogramas de expiração de produtos.

### 12.5 Integrações Fundamentais

| Integração | Função Estratégica |
|---|---|
| **PIX (via Asaas Gateway)** | Pagamento instantâneo com QR Code dinâmico. Split automático entre plataforma e estabelecimento. Custo transacional de R$ 0,99 (3 meses iniciais) a R$ 1,99 por PIX liquidado. |
| **QR Code (Handshake de Entrega)** | Confirmação criptográfica da entrega física: o consumidor exibe o QR Code no celular, o lojista escaneia, a transação muda para 'Entregue' e o repasse financeiro é liquidado — eliminando chargebacks. |
| **Geolocalização (geolocator)** | Ranqueamento de estabelecimentos por proximidade. Garantia de oferta disponível em raio de até 2km. Base para notificações push contextuais. |
| **Google ML Kit (OCR)** | Reconhecimento óptico de caracteres nas embalagens para validação de datas de validade on-device, antes da publicação no servidor. |
| **Supabase Storage (CDN)** | Armazenamento e distribuição eficiente de imagens fotográficas dos produtos, com cache de borda para performance global. |

### 12.6 Custos de Infraestrutura (MVP — 5.000 MAU)
...
### 13.1 Impacto Integrado em Três Dimensões
...
| **Ambiental** | Gera métricas auditáveis de CO₂ evitado por transação. Reduz volume de matéria orgânica em aterros. Viabiliza a obtenção do Selo Doador de Alimentos (Lei nº 15.224/2025) e isenções tributárias estaduais para parceiros B2B. |

### 13.2 Posicionamento de Longo Prazo
...
*— FIM DO DOCUMENTO INSTITUCIONAL OFICIAL —*

*Conecta Mesa | Versão 1.0 | Confidencial*